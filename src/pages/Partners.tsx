...
const Partners = () => {
  ...
  useSeoMeta({
    title: `Partners - ${APP_PROFILE.appName}`,
    description: 'Share 0xSearchstr, track your referrals, and see the affiliate clicks they generate.',
  });
    ...
    <Layout>
      <div className="container max-w-2xl py-10">
        ...
        <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
          Share 0xSearchstr with your invite link. You get credit for the friends you bring
          and the affiliate clicks they generate — tracked on-platform as public,
          pseudonymous Nostr events.
        </p>
        ...
        {!user ? (
          ...
          <div className="space-y-6">
            ...
            <p className="text-[11px] text-muted-foreground/60 leading-relaxed">
              Counts come from public, pseudonymous Nostr events and are indicative
              engagement metrics, not settlement data. Your referred users stay
              pseudonymous: you see counts, not identities.
            </p>
          </div>
        )}
      </div>
